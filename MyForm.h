...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			this->lblTargetInfo = (gcnew System::Windows::Forms::Label());
			this->pictureBoxTarget = (gcnew System::Windows::Forms::PictureBox());
			...
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->pictureBoxTarget))->BeginInit();
			...
			this->lblStatus->Size = System::Drawing::Size(216, 20);
			...
			this->lblRecording->Size = System::Drawing::Size(54, 20);
			...
			// groupBoxTarget
			// 
			this->groupBoxTarget->Controls->Add(this->lblTargetInfo);
			this->groupBoxTarget->Controls->Add(this->pictureBoxTarget);
			this->groupBoxTarget->Font = (gcnew System::Drawing::Font(L"Consolas", 10, System::Drawing::FontStyle::Bold));
			this->groupBoxTarget->Location = System::Drawing::Point(30, 110);
			this->groupBoxTarget->Name = L"groupBoxTarget";
			this->groupBoxTarget->Size = System::Drawing::Size(200, 280);
			...
			this->lblTargetInfo->Font = (gcnew System::Drawing::Font(L"Consolas", 9, System::Drawing::FontStyle::Bold));
			this->lblTargetInfo->Location = System::Drawing::Point(40, 245);
			this->lblTargetInfo->Name = L"lblTargetInfo";
			this->lblTargetInfo->Size = System::Drawing::Size(80, 18);
			this->lblTargetInfo->TabIndex = 1;
			this->lblTargetInfo->Text = L"NO TARGET";
			// 
			// pictureBoxTarget
			// 
			this->pictureBoxTarget->BackColor = System::Drawing::Color::Black;
			this->pictureBoxTarget->BorderStyle = System::Windows::Forms::BorderStyle::FixedSingle;
			this->pictureBoxTarget->Location = System::Drawing::Point(25, 30);
			this->pictureBoxTarget->Name = L"pictureBoxTarget";
			this->pictureBoxTarget->Size = System::Drawing::Size(150, 200);
			...
			this->groupBox1->Location = System::Drawing::Point(260, 110);
			this->groupBox1->Name = L"groupBox1";
			this->groupBox1->Size = System::Drawing::Size(200, 280);
			this->groupBox1->TabIndex = 2;
			this->groupBox1->TabStop = false;
			this->groupBox1->Text = L"[MATCH #1]";
			// 
			// lblScore1
			// 
			...
			this->lblScore1->Size = System::Drawing::Size(128, 18);
			...
			this->groupBox2->Location = System::Drawing::Point(490, 110);
			this->groupBox2->Name = L"groupBox2";
			this->groupBox2->Size = System::Drawing::Size(200, 280);
			this->groupBox2->TabIndex = 3;
			this->groupBox2->TabStop = false;
			this->groupBox2->Text = L"[MATCH #2]";
			// 
			// lblScore2
			// 
			...
			this->lblScore2->Size = System::Drawing::Size(128, 18);
			...
			this->groupBox3->Location = System::Drawing::Point(720, 110);
			this->groupBox3->Name = L"groupBox3";
			this->groupBox3->Size = System::Drawing::Size(200, 280);
			this->groupBox3->TabIndex = 4;
			this->groupBox3->TabStop = false;
			this->groupBox3->Text = L"[MATCH #3]";
			// 
			// lblScore3
			// 
			...
			this->lblScore3->Size = System::Drawing::Size(128, 18);
			...
			this->btnSearchPerson->Location = System::Drawing::Point(391, 420);
			...
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->pictureBoxTarget))->EndInit();
...
#pragma endregion
	...
	private:
		void ApplyTheme()
		{
			...
			lblTargetInfo->ForeColor = Color::FromArgb(255, 200, 0);
			lblScore1->ForeColor = Color::FromArgb(255, 200, 0);
			lblScore2->ForeColor = Color::FromArgb(255, 200, 0);
			lblScore3->ForeColor = Color::FromArgb(255, 200, 0);

			// GroupBoxes
			groupBoxTarget->ForeColor = Color::FromArgb(100, 255, 100);
			groupBox1->ForeColor = Color::FromArgb(100, 255, 100);
			groupBox2->ForeColor = Color::FromArgb(100, 255, 100);
			groupBox3->ForeColor = Color::FromArgb(100, 255, 100);

			// Buttons
			btnSelectTarget->BackColor = Color::FromArgb(30, 30, 40);
			btnSelectTarget->ForeColor = Color::FromArgb(100, 255, 100);
			btnSelectTarget->FlatAppearance->BorderColor = Color::FromArgb(100, 255, 100);

			btnSearchPerson->BackColor = Color::FromArgb(30, 30, 40);
			btnSearchPerson->ForeColor = Color::FromArgb(100, 200, 255);
			btnSearchPerson->FlatAppearance->BorderColor = Color::FromArgb(52, 152, 219);

			btnManageGallery->BackColor = Color::FromArgb(30, 30, 40);
			btnManageGallery->ForeColor = Color::FromArgb(200, 150, 255);
		...
		void SetSelectedTarget(String^ targetPath)
		{
			...
			if (targetPath != nullptr)
			{
				try
				{
					...
					FileStream^ fs = gcnew FileStream(targetPath, FileMode::Open, FileAccess::Read);
					if (pictureBoxTarget->Image != nullptr) delete pictureBoxTarget->Image;
					pictureBoxTarget->Image = Image::FromStream(fs);
					fs->Close();
					delete fs;
					pictureBoxTarget->Refresh();
					
					lblTargetInfo->Text = "TARGET LOCKED";
					lblTargetInfo->ForeColor = Color::FromArgb(255, 200, 0);
				}
				catch (Exception^)
				{
					lblTargetInfo->Text = "ERROR LOADING";
					lblTargetInfo->ForeColor = Color::FromArgb(255, 0, 0);
				}
			...
			{
				if (pictureBoxTarget->Image != nullptr)
				{
					delete pictureBoxTarget->Image;
					pictureBoxTarget->Image = nullptr;
				}
				lblTargetInfo->Text = "NO TARGET";
				lblTargetInfo->ForeColor = Color::FromArgb(255, 200, 0);
			}
		}
